<template>
  <div>
    ...
    <div class="c-box" style="position: absolute; left: 50px; top: 100px;" @click="gotoGoods"><a>商品管理</a></div>
    <div class="c-box" style="position: absolute; left: 250px; top: 50px;" @click="gotoOrder"><a>交易管理</a></div>
    <div class="c-box" style="position: absolute; left: 450px; top: 100px;" @click="gotoBrand"><a>品牌</a></div>
    <div class="c-box" style="position: absolute; left: 650px; top: 50px;" @click="gotoAccount"><a>账号中心</a></div>
    <!--<a-row :gutter="24">
...
<style lang="less" scoped>
  .c-box{
    font-size: 15pt;
    color: #f5222d;
    box-shadow: 2px 2px 10px #f5222d;
    height: 150px;
    width: 150px;
    border-radius: 50%;
    line-height: 150px;
